                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{ url('/admin/done') }}/${data}" title="Detail" class="btn btn-light btn-detail btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                ...
                                <a href="{{ url('/admin/done/edit') }}/${data}" title="Edit" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                        <span class="svg-icon svg-icon-md">
                                ...
                                <a href="{{ url('admin/done') }}/${data}" title="Delete" class="btn btn-light btn-delete btn-sm btn-clean btn-icon" data-toggle="tooltip"  title="Delete">
                                    <span class="svg-icon svg-icon-md">
