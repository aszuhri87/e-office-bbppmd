...
<div class="vertical-modal-ex">
    <!-- Modal -->
    <div class="modal fade" id="modal-wish" tabindex="-1" role="dialog" aria-labelledby="SubUnitModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                       <!-- Basic -->
                       <div class="col-md-12">
                        <form id="form-wish" name="form-wish" class="auth-register-form mt-2" >
                            @csrf
