                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{ url('/admin/wish') }}/${data}" title="Detail" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" data-toggle="tooltip" style="border-radius: 30px 0px 0px 30px;">
                                ...
                                <a href="{{ url('admin/wish') }}/${data}" title="Delete" class="btn btn-light btn-delete btn-sm btn-clean btn-icon" data-toggle="tooltip"  title="Delete" style="border-radius: 0px 30px 30px 0px;">
