    ...
    var LetterTable = function() {
        ...
        const initTable = () => {
            init_table = $('#init-table').DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: "{{ url('chief_div/letter-chief_div/dt') }}",
                },
                columns: [
                    { data: 'DT_RowIndex' },
                    { data: 'name' },
                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{ url('/chief_div/letter-chief_div/edit') }}/${data}" title="Detail" class="btn btn-light btn-detail btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                ...
                                <a href="{{ url('/chief_div/letter-chief_div') }}/${data}" title="Edit" class="btn btn-light btn-edit btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                        <span class="svg-icon svg-icon-md">
                                ...
                                <a href="{{ url('chief_div/letter-chief_div') }}/${data}" title="Delete" class="btn btn-light btn-delete btn-sm btn-clean btn-icon" data-toggle="tooltip"  title="Delete">
                                    <span class="svg-icon svg-icon-md">
