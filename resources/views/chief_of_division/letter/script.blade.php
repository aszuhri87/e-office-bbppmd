            ...
            $(document).on('click', '.btn-detail', function(event){
                ...
                $.get(url, function(data){
                    ...
                    $('#form-letter-create').find('input[name="name"]').val(data.name).attr("disabled", true);
                        ...
                        $('div#link_pdf').append(`
                            <a href="{{url('chief_div/download_pdf/`+data.id+`')}}" class="btn btn-light btn-sm btn-clean btn-icon" data-toggle="tooltip" data-placement="top" title="Print Lembar Disposisi"  >
                        ...
                        $('div#download_all').append(`
                            <a href="{{url('chief_div/download_all/`+data.id+`')}}" class="btn btn-light btn-sm btn-clean btn-icon" data-toggle="tooltip" data-placement="top" title="Download Semua Dokumen"  >
