                    ...
                    },
                    {
                        ...
                        render : function(data, type, full, meta) {
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{ url('/chief/letter-chief/edit') }}/${data}" title="Detail" class="btn btn-light btn-detail btn-sm btn-clean btn-icon" data-toggle="tooltip">
                                ...
                                <a href="{{ url('chief/letter-chief') }}/${data}" title="Delete" class="btn btn-light btn-delete btn-sm btn-clean btn-icon" data-toggle="tooltip"  title="Delete">
                                    <span class="svg-icon svg-icon-md">
