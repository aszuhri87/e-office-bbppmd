                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            ...
                            @endif
                                ...
                                <p class="card-text mb-2"> Masukkan email anda dan kami akan mengirimkan instruksi untuk mereset password</p>
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{ route('password.email') }}" method="POST">
                                    ...
                                    <button class="btn btn-bppm btn-block" tabindex="2">Kirim link reset</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{ route('login') }}" class="text-bppm"> <i data-feather="chevron-left"></i> Kembali ke login </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password v1 -->
