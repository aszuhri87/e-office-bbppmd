...
<head>
    ...
    <title>Reset Password Page - SPS - BBPPM Yogyakarta</title>
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-2">Password baru anda harus berbeda dengan password sebelumnya</p>
                                ...
                                <form class="auth-reset-password-form mt-2" action="{{ route('password.update') }}" method="POST">
                                    ...
                                    <button class="btn btn-bppm btn-block" tabindex="3">Set New Password</button>
                                </form>

                                <p class="text-center mt-2">
                                    <a href="{{ route('login') }}" class="text-bppm"> <i data-feather="chevron-left"></i> Back to login </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Reset Password v1 -->
