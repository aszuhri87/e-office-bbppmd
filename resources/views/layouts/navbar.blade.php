 <!-- BEGIN: Header-->
 <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-dark bg-bppm navbar-shadow container-xxl" style="border-radius: 10px;">
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
                        ...
                        <a class="d-flex" href="javascript:void(0)">
                            <div class="media d-flex align-items-start">
                                ...
                                <div class="media-body">
                                    <p class="media-heading"><span class="font-weight-bolder">Peter Charls mengajukan Surat Lamaran</p><small class="notification-text"> Peter Charls mengajukan Surat Lamaran</small>
                                </div>
                            </div>
                        </a>
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-1" style="border-radius:10px;" aria-labelledby="dropdown-user">
